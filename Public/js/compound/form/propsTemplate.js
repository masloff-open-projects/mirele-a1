if (typeof window.Compound != "undefined") {
    org.references.form.get.template.props = new org.interface({
        requires: {
            vue: true,
            jquery: true
        },
        ...
        vue: {
            ...
            methods: {
                open: function (event) {
                    ...
                    // Create request
                    (org.web.request('Compound/getTemplateProps', event)).then(Event => {
                ...
                submit: function (event) {
                    ...
                    const Request = org.web.request('Compound/updateTemplateProps', Object.assign(this.event, {
                        props: this.props || []
                    }));
