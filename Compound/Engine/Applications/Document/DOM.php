...
class DOM {
     ...
     */
    public function __construct(Template $Template, $TemplateProps, $Areas, $marked = false)
    {
                        ...
                        if ($child instanceof \PHPHtmlParser\Dom\Node\HtmlNode) {
                            ...
                            if ($child->getAttribute('id')) {
                                if (isset($this->ids[$child->getAttribute('id')])) {
                                    throw new \Exception("No two components with the same ID can exist. ID: " . $child->getAttribute('id'));
                                } else {
