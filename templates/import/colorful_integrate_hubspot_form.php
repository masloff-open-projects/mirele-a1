...
/**
 * Rosemary Template: Colorful HubSpot Form Multiblock;
 */


if (MIRELE_INTEGRATION_HUBSPOT) {

    rosemary_register('colorful_hubspot_form', function() {
    ...
    <section class="theme theme-white-no-full-height text-center">
        ...
        <form method="POST" action="form_hubspot" portal_id="<?php echo $form->portalId ?>" guid="<?php echo $form->guid ?>">
                            ...
                            <?php else: ?>
                                ...
                                <?php elseif ($input_box->fieldType == 'radio'): ?>
                                    ...
                                    <?php foreach ($input_box->options as $option): ?>
                                        ...
                                        <div>
                                            <label class='color-dark-light no-full-input-radio margin-x-md'>
                                ...
                                <?php elseif ($input_box->fieldType == 'select'): ?>
                                    ...
                                    <select class="no-full-input margin-x-md" required="<?php echo $input_box->required ? 'required' : '' ?>">
                                ...
                                <?php elseif ($input_box->fieldType == 'number'): ?>
                                    ...
                                    <input type="number" required="<?php echo $input_box->required ? 'required' : '' ?>" name="<?php echo $input_box->name ?>" value="<?php echo $input_box->defaultValue ?>" placeholder="<?php echo $input_ ?>" class="no-full-input margin-x-md">
            ...
            <?php if ($form->captchaEnabled): ?>
                ...
                <p class="margin-lg">
                    <small class="color-dark">Sorry, captcha is not yet supported.</small>
                </p>

            <?php endif; ?>

            <div class="margin-x-md">
                <a href="javascript:;" class="button-light" action="hubspot_form_do"> <?php echo $button ?> <i class="fas fa-chevron-right"></i> </a>
            </div>
    ...
    <?php
        ...
        'title' => 'Colorful HubSpot Form',
        'description' => 'Integrate the form from your HubSpot account!',
        'author' => 'Mirele Colorful Package'
    ));
