    ...
    <div class="row">
        ...
        <?php if ($left) { ?>
            <div class="<?php echo $left; ?>">
                <?php  mirele_execute_component('sidebar', get_option('mrl_wp_sidebar', 'white'),  ( 'left-side-list-products' )); ?>
            </div>
        <?php } ?>
        ...
        <?php if ($right) { ?>
            <div class="<?php echo $right; ?>">
                <?php mirele_execute_component('sidebar', get_option('mrl_wp_sidebar', 'white'), ( 'right-side-list-products' )); ?>
            </div>
        <?php } ?>
